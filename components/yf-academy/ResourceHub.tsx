        ...
        >
          {resources.map((resource, index) => (
            <motion.div
              key={index}
              variants={item}
              className="bg-gray-800 p-8 rounded-lg shadow-lg flex flex-col items-center text-center border-2 border-transparent hover:border-amber-500 transition-colors duration-300"
            >
